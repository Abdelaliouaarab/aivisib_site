  ...
  en: {
    ...
    needs: [
      ...
      ["An agency with about ten clients",
       "AIVisib Agency is $399 a month for ten brands, which is $40 per client, with white-label reports and client share links included. Extra brands are $39 a month each. Peec AI and Profound work on credits; Otterly.AI's Standard plan is $189 for 100 prompts."],
      ["Measuring in Arabic",
  ...
  fr: {
    ...
    needs: [
      ...
      ["Une agence avec une dizaine de clients",
       "L'offre Agency d'AIVisib coûte 399 $ par mois pour dix marques, soit 40 $ par client, rapports en marque blanche et liens de partage inclus. Chaque marque supplémentaire coûte 39 $ par mois. Peec AI et Profound fonctionnent au crédit ; l'offre Standard d'Otterly.AI est à 189 $ pour 100 questions."],
      ["Mesurer en arabe",
  ...
  ar: {
    ...
    needs: [
      ...
      ["وكالة لديها نحو عشرة عملاء",
       "باقة Agency في AIVisib بـ399 دولاراً شهرياً لعشر علامات، أي 40 دولاراً لكل عميل، مع تقارير بعلامة الوكالة وروابط مشاركة للعملاء. وكل علامة إضافية بـ39 دولاراً شهرياً. أما Peec AI وProfound فيعملان بنظام الأرصدة، وباقة Otterly.AI القياسية بـ189 دولاراً لمئة سؤال."],
      ["القياس بالعربية",
