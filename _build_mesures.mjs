...
const cards = ITEMS.map(([id]) => `<figure class="msf" id="${id}"><a href="/brand/linkedin/${id}.png" target="_blank" rel="noopener" title="" data-i-title="ms_open"><img src="/brand/linkedin/${id}.png" alt="" loading="lazy"></a><figcaption data-i="mi_${id}"></figcaption></figure>`).join("\n");
